...
int gamePower(map<string,int> observedNBalls) {
    int result = 1;
    for(const auto&[key, value] : observedNBalls) {
        result *= value;
    }
    return result;
}
...
int main() {
    ...
    string line;
    int totalSum = 0, sumPowers = 0, i = 1;
    ...
    while (getline(inputFile, line)) {
        ...
        sumPowers += gamePower(gameMaxScores);
    ...
    cout << "Sum of powers: " << sumPowers << endl;
